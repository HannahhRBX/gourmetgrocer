...
ClickByText('a','Category Management') #href buttons require a class instead of button, therefore needing clickByText function
ClickButtonByText('Add Category') #Add a new Category
time.sleep(1)
EnterByID("CatagoryName","Apples")
