...
def SelectDropdownByText(xpath,text):
...
ClickByText('a','User Management') #href buttons require a class instead of button, therefore needing clickByText function
ClickButtonByText('Edit')
time.sleep(0.5)
EnterText("/html/body/div[3]/div/div/div[2]/form/div[1]/input","John") #Enter text directly through XPATH
EnterText("/html/body/div[3]/div/div/div[2]/form/div[2]/input","Doe")
EnterText("/html/body/div[3]/div/div/div[2]/form/div[3]/input","johndoe@gmail.com")
SelectDropdownByText("/html/body/div[3]/div/div/div[2]/form/div[4]/select","Admin")
