...
<div class="container mt-4">
    ...
    <table class="table table-striped"> 
        ...
        <tbody>
            <?php foreach ($roles as $role): ?> <!-- Loop through each category item -->
                <tr>
                    ...
                    if ($userRole == 'admin'){
                        ...
                        <form action="./Roles.php" method="post" style="padding-right: 10px; float: left;">
                        ...
                        <input type="hidden" name="objectId" value="<?= $role['id']; ?>">
                        <input type="hidden" name="objectName" value="<?= $role['name']; ?>">
                        </form>
                        <form action="./Roles.php" method="post" style="float: left;">
